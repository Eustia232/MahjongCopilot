...
class Settings:
    ...
    def __init__(self, json_file:str=DEFAULT_SETTING_FILE) -> None:
        ...
        self.schedule_rotate_on_hours:float = self._get_value("schedule_rotate_on_hours", 4.0, self.valid_positive_float)
        self.schedule_rotate_off_hours:float = self._get_value("schedule_rotate_off_hours", 3.0, self.valid_positive_float)
        self.schedule_rotate_next_switch_at:str = self._get_value("schedule_rotate_next_switch_at", "", self.valid_str)

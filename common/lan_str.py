...
class LanStr:
    ...
    SCHEDULE_MODE_ROTATE = "Rotate"
    SCHEDULE_FIXED_START = "Start Time"
    SCHEDULE_FIXED_END = "End Time"
    SCHEDULE_ROTATE_ON = "On Hours"
    SCHEDULE_ROTATE_OFF = "Off Hours"
    SCHEDULE_STATUS = "Schedule Status"
    SCHEDULE_STATUS_ON = "On"
    SCHEDULE_STATUS_OFF = "Off"
    SCHEDULE_STATUS_WAITING = "Waiting to close"
    SCHEDULE_NEXT_SWITCH = "Next Switch"
    ...
    MJAI_2_STR = {
        ...
        'reach': 'Riichi', 'chi_low': 'Chi Low', 'chi_mid': 'Chi Mid', 'chi_high': 'Chi High', 'pon': 'Pon',
        'kan_select': 'Kan',
...
class LanStrZHS(LanStr):
    ...
    SCHEDULE_TITLE = "定时控制"
    SCHEDULE_ENABLE = "启用定时"
    SCHEDULE_MODE = "模式"
    SCHEDULE_MODE_FIXED = "固定时段"
    SCHEDULE_MODE_ROTATE = "轮换"
    SCHEDULE_FIXED_START = "开始时间"
    SCHEDULE_FIXED_END = "结束时间"
    SCHEDULE_ROTATE_ON = "开启小时"
    SCHEDULE_ROTATE_OFF = "关闭小时"
    SCHEDULE_STATUS = "定时状态"
    SCHEDULE_STATUS_ON = "开启"
    SCHEDULE_STATUS_OFF = "关闭"
    SCHEDULE_STATUS_WAITING = "等待结束"
    SCHEDULE_NEXT_SWITCH = "下次切换"
